...
const AboutCreative = () => {
  return (
    <div className="w-full h-auto pt-[60px] sm:pt-[80px] lg:pt-[120px] pb-[40px] sm:pb-[60px] lg:pb-[100px]">
      <div className="w-[90%] sm:w-[50%] mx-auto text-center font-poppin">
      ...
      <div className="w-[85%] h-auto mx-auto mt-[60px] mb-[30px]">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 sm:gap-x-8 gap-y-8">
      ...
      <div className="w-full text-center">
        <DynamicButton btnCreative="border-pBlue text-pBlue text-[.75rem] font-[600] px-7 py-4 tracking-[.1125rem] capitalize duration-500 hover:bg-pBlue hover:text-white">
          SERVICES
        </DynamicButton>
      </div>
    </div>
