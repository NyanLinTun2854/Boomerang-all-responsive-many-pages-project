...
const YourSite = () => {
    ...
    return (
        <div className='w-full h-auto font-poppin border-b border-b-[#f0f0f0]'>
            <div className='w-[90%] h-full mx-auto py-[120px]'>
                <div className='w-[50%] mx-auto text-center'>
                    <Titile>Your Site, Your Way.</Titile>
                    <Expression>
                        See how your users experience your website in realtime or view
                        <br />
                        trends to see any changes in performance over time.</Expression>
                </div>
                <div className='w-full h-[426px] my-[60px]'>
                    <img src="https://offsetcode.com/themes/boomerang/1.3/assets/images/main/mega-mockup.png" alt="" className='w-full h-full' />
                </div>
