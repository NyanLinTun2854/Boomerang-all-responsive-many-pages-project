...
const AboutAdventages = () => {
    return (
        <div className='w-full mx-auto h-auto grid grid-cols-3 font-poppin pt-[40px] pb-[100px]'>
            <div className='w-full h-auto group/image cursor-pointer flex  justify-start pl-16 py-[20px]'>
                ...
                <div className='flex flex-col items-start'>
                    ...
                    <p className='text-[.875rem] font-[400] text-[#788487] text-start leading-[1.8]'>
                        ...
                        <br />website inrealtime or view trends to see
                        <br /> any changes in
                        performance.
                    </p>
                </div>
            </div>
            <div className='w-full h-auto group/image cursor-pointer flex  justify-start pl-10 py-[20px]'>
                <div className='w-[35px] h-[35px] flex justify-start items-center mb-3 mr-8'>
            ...
            <div className='w-full h-auto group/image cursor-pointer flex  justify-start pl-6 py-[20px]'>
                <div className='w-[35px] h-[35px] flex justify-start items-center mb-3 mr-8'>
