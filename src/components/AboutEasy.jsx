...
const AboutEasy = () => {
  return (
    <div className="w-full h-auto font-poppin pt-[120px] pb-[100px] border-b border-[#f0f0f0]">
      <div className="w-[100%] sm:w-[80%] lg:w-[90%] mx-auto flex flex-col lg:flex-row justify-center items-center gap-y-8">
        <div className="w-[100%] lg:w-[50%] h-full">
          <div className="w-[100%] px-4 h-full">
            <img
              src="https://offsetcode.com/themes/boomerang/1.3/assets/images/main/about-4.jpg"
              alt=""
              className="w-full h-full object-cover"
            />
          </div>
        </div>
        <div className="w-[80%] lg:w-[50%] mx-auto h-full flex justify-start pl-0 lg:pl-[60px]">
          <div>
            <div>
              <h1 className="text-[2rem] leading-[1.3] text-[#222] font-[400]">
                Easy and Simple
              </h1>
            </div>
            <div className="my-[1rem]">
              <p className="text-[.9375rem] font-[400] tracking-[.01875rem] leading-[1.8] text-[#788487]">
                ...
                <br />
                or view trends to see any changes in performance.
              </p>
            </div>
