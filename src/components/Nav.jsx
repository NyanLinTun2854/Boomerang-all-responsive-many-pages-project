...
//           "w-full fixed z-10 flex justify-center font-poppin border-b-[1px]  border-b-lightWhite h-[72px] duration-500 orign-top top-0 right-0 left-0 overflow-x-hidden px-6"
//         )}
//       >
//         <div className="container h-full flex justify-between items-stretch">
//           <div className="flex items-center w-[20%]">
//             <a href="#" className="text-[1.25rem] font-[600]">
//               Boomarag
//             </a>
//           </div>
//           <ul className="hidden md:flex justify-between items-center w-[45%]  gap-6 uppercase text-[0.75rem] font-[600]">
//             <li
//               className={classNames(
//                 scrollPosition > 0 ? "after:bg-black" : "after:bg-white",
//                 "relative h-full flex items-center after:absolute after:bottom-0 after:w-[15px] after:h-[1.5px] after:-translate-x-[50%] after:left-[50%] hover:after:w-full after:duration-500 cursor-pointer"
//               )}
//             >
//               <NavLink
//                 to="/"
...
//               </div>
//             </NavLink>
//             <div className="text-xl cursor-pointer" onClick={handleNav}>
//               <HiOutlineMenu />
//             </div>
//           </div>
//         </div>
...
//           "w-[400px] h-[100vh] bg-[#222]  fixed top-0 z-50 overflow-auto font-poppin duration-500 origin-right"
//         )}
//       >
      ...
      <div>
        <div
          className={classNames(
            scrollPosition > 0
              ? "scale-y-[110%] text-black bg-white shadow-lg"
              : "scale-y-1 text-black lg:text-white bg-white lg:bg-transparent",
