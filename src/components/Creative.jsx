    ...
    return (
        <div className='w-full h-auto pt-[120px] pb-[100px]'>
            ...
            <div className='w-full text-center'>
                <DynamicButton btnCreative="border-pBlue text-pBlue text-[.75rem] font-[600] px-7 py-4 tracking-[.1125rem] duration-500 hover:bg-pBlue hover:text-white">ABOUT US</DynamicButton>
            </div>
        </div>
    )
}
